...
levelAlpha.prototype.cleanup= function() {
}

levelAlpha.prototype.init = function() {
  this.init_flag=true;
...
levelAlpha.prototype.meta_map = function(ele_to_map, func_to_call) {
...
levelAlpha.prototype.bbox = function(r,c) {
  for (var ii=0; ii<this.tilemap.layers.length; ii++) {
...
levelAlpha.prototype.update = function() {
...
levelAlpha.prototype.keyDown = function(code) {
  //console.log(">> levelAlpha keyDown", code);
...
levelAlpha.prototype.event = function(event_type, data) {
  if (!this.ready) { return; }
...
levelAlpha.prototype.draw_layer_bottom = function(display_name, cmp_x, cmp_y) {
  if (!this.ready) { return; }
...
levelAlpha.prototype.draw_layer_top = function(display_name, cmp_x, cmp_y) {
  if (!this.ready) { return; }
...
//levelAlpha.prototype.draw_layer_w = function(display_name, anchor_x, anchor_y, window_r, window_c, alpha) {
levelAlpha.prototype.draw_layer_w = function(display_name, anchor_x, anchor_y, window_c, window_r, alpha) {
...
levelAlpha.prototype.draw_layer = function(display_name) {
  if (!this.ready) { return; }
  if (!(display_name in this.layer_name_index_lookup)) { return; }
...
levelAlpha.prototype.draw = function(display_height, data) {
  if (!this.ready) { return; }
