...
dungeonAqua.prototype.cleanup= function() {
}

dungeonAqua.prototype.init = function() {
  this.init_flag=true;
...
dungeonAqua.prototype.layer_map = function(layer_name, ele_to_map, func_to_call) {
...
dungeonAqua.prototype.meta_map = function(ele_to_map, func_to_call) {
...
dungeonAqua.prototype.bbox = function(r,c) {
  for (var ii=0; ii<this.tilemap.layers.length; ii++) {
...
dungeonAqua.prototype.update = function() {
...
dungeonAqua.prototype.keyDown = function(code) {
  //console.log(">> dungeonAqua keyDown", code);
...
dungeonAqua.prototype.event = function(event_type, data) {
  if (!this.ready) { return; }
...
dungeonAqua.prototype.draw_layer = function(display_name) {
  if (!this.ready) { return; }
...
dungeonAqua.prototype.draw = function(display_height, data) {
  if (!this.ready) { return; }
