...
levelBeta.prototype.cleanup= function() {
}

levelBeta.prototype.init = function() {
  this.init_flag=true;
...
levelBeta.prototype.meta_map = function(ele_to_map, func_to_call) {
...
levelBeta.prototype.bbox = function(r,c) {
  for (var ii=0; ii<this.tilemap.layers.length; ii++) {
...
levelBeta.prototype.update = function() {
...
levelBeta.prototype.keyDown = function(code) {
  //console.log(">> levelBeta keyDown", code);
...
levelBeta.prototype.event = function(event_type, data) {
  if (!this.ready) { return; }
...
levelBeta.prototype.draw_layer_bottom = function(display_name, cmp_x, cmp_y) {
  if (!this.ready) { return; }
...
levelBeta.prototype.draw_layer_top = function(display_name, cmp_x, cmp_y) {
  if (!this.ready) { return; }
...
//levelBeta.prototype.draw_layer_w = function(display_name, anchor_x, anchor_y, window_r, window_c, alpha) {
levelBeta.prototype.draw_layer_w = function(display_name, anchor_x, anchor_y, window_c, window_r, alpha) {
...
levelBeta.prototype.draw_layer = function(display_name) {
  if (!this.ready) { return; }
  if (!(display_name in this.layer_name_index_lookup)) { return; }
...
levelBeta.prototype.draw = function(display_height, data) {
  if (!this.ready) { return; }
