...
dungeonBlood.prototype.cleanup= function() {
}

dungeonBlood.prototype.init = function() {
  this.init_flag=true;
...
dungeonBlood.prototype.bbox = function(r,c) {
  for (var ii=0; ii<this.tilemap.layers.length; ii++) {
...
dungeonBlood.prototype.update = function() {
...
dungeonBlood.prototype.keyDown = function(code) {
  //console.log(">> dungeonBlood keyDown", code);
...
dungeonBlood.prototype.event = function(event_type, data) {
  if (!this.ready) { return; }
...
dungeonBlood.prototype.draw_layer_bottom = function(display_name, cmp_x, cmp_y, a) {
...
dungeonBlood.prototype.draw_layer_top = function(display_name, cmp_x, cmp_y, a) {
  a = ((typeof a === "undefined") ? 1.0 : a);
  if (!this.ready) { return; }
...
dungeonBlood.prototype.draw_layer_w = function(display_name, anchor_x, anchor_y, window_c, window_r, alpha) {
  var test_flag = false;
...
dungeonBlood.prototype.draw_layer = function(display_name) {
  if (!this.ready) { return; }
...
dungeonBlood.prototype.draw = function(display_height, data) {
  if (!this.ready) { return; }
