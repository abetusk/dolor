...
dungeonJade.prototype.layer_map = function(layer_name, ele_to_map, func_to_call) {
...
dungeonJade.prototype.draw_layer_bottom = function(display_name, cmp_x, cmp_y, a) {
...
dungeonJade.prototype.draw_layer_top = function(display_name, cmp_x, cmp_y, a) {
  a = ((typeof a === "undefined") ? 1.0 : a);
  if (!this.ready) { return; }
