...
levelDolor.prototype.meta_map = function(ele_to_map, func_to_call) {
...
levelDolor.prototype.bbox = function(r,c) {
  for (var ii=0; ii<this.tilemap.layers.length; ii++) {
...
levelDolor.prototype.keyDown = function(code) {
  //console.log(">> levelDolor keyDown", code);
...
levelDolor.prototype.event = function(event_type, data) {
  if (!this.ready) { return; }
...
levelDolor.prototype.draw_layer_bottom = function(display_name, cmp_x, cmp_y) {
  if (!this.ready) { return; }
...
levelDolor.prototype.draw_layer_top = function(display_name, cmp_x, cmp_y) {
  if (!this.ready) { return; }
...
levelDolor.prototype.draw_layer = function(display_name) {
  if (!this.ready) { return; }
...
levelDolor.prototype.draw = function(display_height, data) {
  if (!this.ready) { return; }
