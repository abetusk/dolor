...
mainPlayer.prototype.keyDown = function(code) {
  ...
  */
  ...
  //
  if (code==37) {
    //if (!this.walkFlag["left"]) { this.walkq.push({ "d": "left", "t" : 5 }); }
    //this.walkFlag["left"] = true;
  ...
  //
    ...
    //if (!this.walkFlag["up"]) { this.walkq.push({ "d":"up", "t":5 }); }
    //this.walkFlag["up"] = true;
  ...
  //
    ...
    //if (!this.walkFlag["right"]) { this.walkq.push({ "d":"right", "t":5 }); }
    //this.walkFlag["right"] = true;
  ...
  //
    ...
    //if (!this.walkFlag["down"]) { this.walkq.push({ "d":"down", "t":5 }); }
    //this.walkFlag["down"] = true;
...
mainPlayer.prototype.draw = function() {
  ...
  var d;
  if (n>=0) {
    d = this.currentDisplayDirection();
