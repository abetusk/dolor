function creatureBones() {
  ...
  this.name = "bones";
  this.dead_name = "dead_bones";

  this.mask_dead_name = "mask_dead_bones";
  this.mask_name = "mask_bones";
...
creatureBones.prototype.init = function(x,y, d) {
...
creatureBones.prototype.update_hit_bbox = function(bbox,x,y) {
  bbox[0][0] = x + 2;
  bbox[0][1] = y + 0;
...
creatureBones.prototype.update_bbox = function(bbox,x,y) {
  bbox[0][0] = x;
  bbox[0][1] = y;
...
creatureBones.prototype.hit = function(damage) {
...
creatureBones.prototype.update_intent = function(d) {
  this.intent.d = d;
...
creatureBones.prototype.realize_intent = function() {
...
creatureBones.prototype.update = function(world) {
  var intent_d = this.d;
